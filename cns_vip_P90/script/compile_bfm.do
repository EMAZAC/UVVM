...
# Set lib_name
#------------------------------------------------------
quietly set lib_name cns_vip_P90
...
echo "eval vcom  $compdirectives  $source_path/src/asm330_bfm_pkg.vhd"
eval vcom  $compdirectives  $source_path/src/asm330_bfm_pkg.vhd