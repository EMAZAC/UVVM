...
#------------------------------------------------------
set source_path [pwd]
set component_list_path "$source_path/component_list.txt"
...
if { [info exists 1] } {
  ...
  ##if {$argc >= 2} {
  ##  set target_path "$2"
  ##  set default_target 1

  ##  if {$argc >= 3} {
  ##    set component_list_path "$3"
  ##  }
  ##}
}
...
#------------------------------------------------------
set fp [open "$component_list_path" r]
...
foreach item $file_data {
  if {$default_target == 0} {
    set target_path "$source_path/../$item/sim"
  }
  set component_path "$source_path/../$item"
